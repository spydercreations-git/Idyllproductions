        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
            ...
            <div className="relative">
              <div className="aspect-[4/3] bg-slate-50 rounded-2xl flex items-center justify-center shadow-lg overflow-hidden border-2 border-slate-200">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:border-slate-300 hover:shadow-lg transition-all duration-300">
