    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 md:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <Link 
            to="/"
            className="inline-flex items-center gap-2 font-medium mb-8 transition-all duration-300 hover:scale-105"
            style={{
          ...
          >
            <ArrowLeft className="w-5 h-5" style={{ color: '#FF6B35' }} />
            Back to Home
          </Link>
          ...
          <div className="text-center mb-16">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm sm:text-base text-slate-700">
              ...
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5" style={{ color: '#FF69B4' }} />
                <span>100+ Videos/Day</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5" style={{ color: '#9370DB' }} />
                ...
                {loadingVideos[index] && (
                  <div className="absolute inset-0 bg-black/80 flex items-center justify-center z-10">
                    <div className="flex gap-2">
                      <div className="w-3 h-3 rounded-full animate-bounce" style={{ background: '#FF6B35', animationDelay: '0ms' }}></div>
                      <div className="w-3 h-3 rounded-full animate-bounce" style={{ background: '#FF69B4', animationDelay: '150ms' }}></div>
                      <div className="w-3 h-3 rounded-full animate-bounce" style={{ background: '#9370DB', animationDelay: '300ms' }}></div>
                    </div>
                  </div>
                )}
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-8" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {deliverySteps.map((step, index) => (
              <div 
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderImage = 'linear-gradient(135deg, #FF6B35 0%, #F7931E 25%, #FF69B4 50%, #DA70D6 75%, #9370DB 100%) 1';
                }}
                onMouseLeave={(e) => {
          ...
          <div className="text-center">
            <Link
              to="/"
              className="inline-flex items-center gap-2 px-8 py-4 text-white rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
              style={{
                background: '#111111'
              }}
              onMouseEnter={(e) => {
