          ...
          <div className="relative w-full max-w-7xl bg-white rounded-[2.5rem] md:rounded-[4rem] overflow-hidden shadow-2xl animate-scale-up flex flex-col max-h-[95vh] border border-gray-100">
            ...
            <div className="p-6 md:p-12 overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                {selectedCategory.previews.map((video, idx) => (
                  <div key={idx} className="group relative rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500">
                    <div className="absolute top-4 left-4 z-20 px-3 py-1 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full text-[9px] font-black text-white uppercase tracking-widest pointer-events-none">
                      Clip 0{idx + 1}
                    </div>
                    <HoverHlsVideo
                      src={video}
