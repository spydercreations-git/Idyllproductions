...
const Home: React.FC = () => {
  ...
  const editingCategories = [
    {
      ...
      videos: [
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771445956/Ad_3_yjf16k.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771445945/Ad_4_cscxhi.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771445944/Ad_6_ojjosz.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771445941/Ad_2_ihfrh6.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771445935/Ad_7_ivpxrx.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771445924/Ad_1_yj6kes.mp4"
      ]
    },
    {
      name: "Long-Form",
      ...
      videos: [
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139228/3_qkje2a.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139228/4_cytkq8.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139227/2_do5gug.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139223/1_svocia.mp4"
      ]
    },
    {
      ...
      videos: [
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771140447/4_z6bab2.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771446228/3_q5p9dz.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771140447/5_aio4t7.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771140446/1_xidnwc.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771140446/2_jujvd0.mp4"
      ]
    },
    {
      name: "Gaming Content",
      ...
      videos: [
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139708/5_o8klwi.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139705/4_e6ts4n.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139703/3_tomzan.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139702/2_otbyba.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771139702/1_cphmkn.mp4"
      ]
    },
    {
      ...
      videos: [
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771447684/3_tg1g30.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771447680/1_rns9xe.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771447671/4_r7ekto.mp4",
        "https://res.cloudinary.com/dp8h3of4r/video/upload/v1771447669/2_fxnrbq.mp4"
      ]
    }
  ];
  ...
  return (
    <div className="bg-white min-h-screen relative overflow-hidden">
      ...
      <section className="relative pt-32 sm:pt-32 md:pt-64 pb-24 sm:pb-32 md:pb-48 px-4 sm:px-6 md:px-8 overflow-hidden z-10">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="reveal active">
            {/* Rounded Badge Above Title */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 rounded-full mb-6 animate-slide-up">
              <span className="w-2 h-2 bg-blue-600 rounded-full"></span>
              <span className="text-blue-700 font-medium text-sm sm:text-base">
                Your Trusted Editing Partner
              </span>
            </div>
            
            <h1 className="font-sf-pro text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-semibold tracking-tight text-slate-900 leading-[0.9] mb-8 sm:mb-8 md:mb-12 animate-slide-up">
              Idyll Productions
            </h1>
            
            <h2 className="font-sf-pro text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-normal tracking-tight text-slate-700 leading-[1.2] mb-8 sm:mb-8 md:mb-10 animate-slide-up px-4 sm:px-0" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="relative max-w-7xl mx-auto mb-12 sm:mb-16" style={{ perspective: '1200px' }}>
              ...
              >
                ...
                >
                  <source src="https://res.cloudinary.com/dp8h3of4r/video/upload/v1771138814/main_white_abs5nz.mp4" type="video/mp4" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <h2 className="font-sf-pro text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-tight text-slate-900 mb-4 sm:mb-6 md:mb-8">
              Best Editors Team for <span className="text-blue-600">UGC Content</span>
            </h2>
            ...
            {/* Meta Ecosystem Badge */}
            <div className="flex items-center justify-center gap-2 sm:gap-3 mt-6 sm:mt-8">
              <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 flex items-center justify-center overflow-hidden rounded-lg flex-shrink-0">
                <video
                  src="https://res.cloudinary.com/dtocytxbv/video/upload/v1771448381/animation-mp4_q7dx1d.mp4"
                  autoPlay
                  loop
                  muted
                  playsInline
              ...
              <p className="font-inter text-xs sm:text-sm md:text-base lg:text-lg text-slate-700 font-semibold whitespace-nowrap">
                Powering Campaigns Inside the Meta Ecosystem
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mb-12 sm:mb-16 px-2 sm:px-4">
            ...
            <button
              ...
              className="flex-shrink-0 w-11 h-11 sm:w-12 sm:h-12 bg-white border-2 border-blue-500 hover:border-blue-600 hover:bg-blue-50 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg z-10"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="group relative">
                <div className="relative bg-white rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-blue-100 transition-all duration-500 hover:-translate-y-1 transform h-full">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-blue-50 flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-blue-100 transition-all duration-500 text-blue-600">
                    {service.icon}
                  </div>
                  <h3 className="font-sf-pro text-base sm:text-lg font-semibold text-slate-900 mb-2 sm:mb-3 group-hover:text-blue-600 transition-colors">{service.title}</h3>
                  <p className="font-inter text-xs sm:text-sm text-slate-600 leading-relaxed">{service.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* --- CONTACT US SECTION --- */}
      <section id="contact-us" className="py-32 px-8 relative overflow-hidden z-10 bg-slate-50">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto relative h-14 px-6 rounded-lg text-base font-medium bg-white border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-50 transition-all duration-300 hover:scale-105 transform shadow-xl hover:shadow-2xl flex flex-col items-center justify-center"
              >
              ...
              <a 
                ...
                className="w-full sm:w-auto relative h-14 px-6 rounded-lg text-base font-medium bg-white border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-50 transition-all duration-300 hover:scale-105 transform shadow-xl hover:shadow-2xl flex flex-col items-center justify-center"
              >
                <span className="font-semibold text-blue-600 hover:text-blue-700">harsh@idyllproductions.com</span>
