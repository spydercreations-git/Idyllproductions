          ...
          <div className="mb-12 sm:mb-16 md:mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 text-center hover:shadow-[0_20px_60px_rgb(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-500">
                ...
                <h3 className="text-xl sm:text-2xl font-black text-[#001B3D] mb-1 sm:mb-2">Parth</h3>
                <p className="text-xs sm:text-sm font-semibold text-[#0070F3] uppercase tracking-widest mb-2 sm:mb-4">CDO - Chief Data Officer</p>
                <p className="text-sm sm:text-base text-[#001B3D]/50 leading-relaxed font-normal">
                  Manages the industrial software for internal databases and ensures data integrity across all systems.
                </p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 text-center hover:shadow-[0_20px_60px_rgb(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-500">
                ...
                <h3 className="text-xl sm:text-2xl font-black text-[#001B3D] mb-1 sm:mb-2">Our Editors</h3>
                <p className="text-xs sm:text-sm font-semibold text-[#0070F3] uppercase tracking-widest mb-2 sm:mb-4">20+ High Skilled Editors</p>
                <p className="text-sm sm:text-base text-[#001B3D]/50 leading-relaxed font-normal">
